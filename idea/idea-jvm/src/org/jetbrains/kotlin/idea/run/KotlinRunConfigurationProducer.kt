...
import org.jetbrains.kotlin.idea.project.getLanguageVersionSettingsOrDefault
    ...
    companion object {
        fun getEntryPointContainer(locationElement: PsiElement): KtDeclarationContainer? {
            ...
            val mainFunctionDetector =
                MainFunctionDetector(psiFile.getLanguageVersionSettingsOrDefault()) { it.resolveToDescriptorIfAny(BodyResolveMode.FULL) }
